...
UPDATE public.posts 
SET "imageUrl" = 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=1632&auto=format&fit=crop'
WHERE slug = 'brand-innovation-guide';

UPDATE public.posts 
SET "imageUrl" = 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=1470&auto=format&fit=crop'
WHERE slug = 'startup-branding-golden-time';

UPDATE public.posts 
SET "imageUrl" = 'https://images.unsplash.com/photo-1553877606-3c02d288820c?q=80&w=1470&auto=format&fit=crop'
WHERE slug = 'avoiding-branding-mistakes';

UPDATE public.posts 
SET "imageUrl" = 'https://images.unsplash.com/photo-1558655146-d09347e0b7a9?q=80&w=1470&auto=format&fit=crop'
WHERE slug = 'visual-language-power';


-- 2. Insert Projects from the original website
-- We use ON CONFLICT DO NOTHING to avoid duplicate errors if run multiple times
